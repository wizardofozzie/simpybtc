...
# class TestPbkdf_two(unittest.Testcase):
#     @classmethod
#     def setUpClass(cls):
...
#     def test_all(self):
#         strpasswords = [
#             b'All n-entities must communicate with other n-entities via n-1 entiteeheehees',
#             b'eaimrbzpcopbusaqtkmw'     # unhexlify('6561696D72627A70636F706275736171746B6D77')
#         ]
#
#         strsalts = [
#             b'\x124VxxV4\x12'                                           # unhexlify( '1234567878563412' )
#             b'E$\x8f\x9d\x0c\xeb\xcb\x86\xa1\x82C\xe7l\x97*\x1f;6w*'    # unhexlify('45248F9D0CEBCB86A18243E76C972A1F3B36772A')
#         ]
#         stritercounts = [
#             500,
#             100
...
#
#         strreturns = [
#             b'j\x89p\xbfh\xc9,\xae\xa8J\x8d\xf2\x85\x10\x85\x86',
#             b'\xc9\xa0\xb2b/\x13\x91`6\xe2\x9etb\xe2\x06\xe8\xba[P\xce\x92\x12u.\xb8\xea*J\xa7\xb4\nL\xc1\xbf'
#         ]
