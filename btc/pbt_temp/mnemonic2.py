...
from btc.bci import *    # pybitcointools library, importing URL grabber
from btc.main import *   # pybitcointools library...
...
try:
    ...
    try:
        global BIP39WORDS
        BIP39WORDS = make_request("https://raw.githubusercontent.com/btc/bips/master/bip-0039/english.txt").decode('utf-8').split('\n')
...
def bip39_mnemonic_to_seed(mnemonic):
    ...
    See BIP39: https://github.com/btc/bips/blob/master/bip-0039.mediawiki#generating-the-mnemonic
